      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="prose prose-lg max-w-none space-y-6">
          <p className="text-muted-foreground">
            Настоящий документ является официальным предложением (офертой) о заключении договора купли-продажи между ИП Андрианов Илья Олегович и любым посетителем сайта svetdom.shop.
          </p>
