...
export const products: Product[] = [
  ...
  { id: 19, name: "Лампа LED E27 10W", power: "10W", lightColor: "Теплый", price: 289, image: "https://images.unsplash.com/photo-1581090464777-f3220bbe1b8b?auto=format&fit=crop&q=80", category: "set", compatibleWith: [20] },
  { id: 20, name: "Лампа LED E27 7W", power: "7W", lightColor: "Холодный", price: 711, image: "https://images.unsplash.com/photo-1500673922987-e212871fec22?auto=format&fit=crop&q=80", category: "set", compatibleWith: [19] },
  
  // Аварийные лампы
  { id: 21, name: "Аварийная лампа E27 9W", power: "9W", lightColor: "Нейтральный", price: 347, image: "https://images.unsplash.com/photo-1500673922987-e212871fec22?auto=format&fit=crop&q=80", category: "set", compatibleWith: [22] },
  ...
  { id: 27, name: "Аварийная лампа E27 9W", power: "9W", lightColor: "Нейтральный", price: 743, image: "https://images.unsplash.com/photo-1500673922987-e212871fec22?auto=format&fit=crop&q=80", category: "set", compatibleWith: [28] },
  { id: 28, name: "Аварийная лампа E27 12W", power: "12W", lightColor: "Теплый", price: 1257, image: "https://images.unsplash.com/photo-1500673922987-e212871fec22?auto=format&fit=crop&q=80", category: "set", compatibleWith: [27] },
  
  // Декоративные лампы  
  { id: 29, name: "Декоративная свеча E27 5W", power: "5W", lightColor: "Теплый", price: 891, image: "https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?auto=format&fit=crop&q=80", category: "set", compatibleWith: [30] },
  { id: 30, name: "Декоративный шар E27 10W", power: "10W", lightColor: "Нейтральный", price: 1109, image: "https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?auto=format&fit=crop&q=80", category: "set", compatibleWith: [29] },
  ...
  { id: 33, name: "Декоративная свеча E27 13W", power: "13W", lightColor: "Нейтральный", price: 1347, image: "https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?auto=format&fit=crop&q=80", category: "set", compatibleWith: [34] },
  { id: 34, name: "Декоративный шар E27 8W", power: "8W", lightColor: "Теплый", price: 1653, image: "https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?auto=format&fit=crop&q=80", category: "set", compatibleWith: [33] },
  { id: 35, name: "Декоративная свеча E27 14W", power: "14W", lightColor: "Холодный", price: 1289, image: "https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?auto=format&fit=crop&q=80", category: "set", compatibleWith: [36] },
  { id: 36, name: "Декоративный шар E27 6W", power: "6W", lightColor: "Нейтральный", price: 1711, image: "https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?auto=format&fit=crop&q=80", category: "set", compatibleWith: [35] },
